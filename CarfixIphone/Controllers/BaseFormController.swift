...
////        self.oriTitle = self.navigationItem.title
////        self.title = ""
//        
...
//        self.title = self.oriTitle ?? self.navigationItem.title
//        
...
//                    aRect.size.height = aRect.size.height + activeTextField.frame.size.height + Config.padding
//                    
//                    view.frame = aRect
//                    
